...
public class Editor extends JPanel implements MouseListener, MouseMotionListener, ActionListener
{
    ...
    //Default Border of the ball Button
    private Border ballBorder;
    ...
    //Arraylist of the tile buttons (not the ball)
    private ArrayList<EditorButton> tileButtons;
    ...
    public Editor(LevelDescription startLevel)
    {
        ...
        tileButtons = new ArrayList<EditorButton>();
    ...
    public void makeFrame()
    {
        ...
        for (TileType t : TileType.values()) {
            if (!notEditorTiles.contains(t)) {
                ...
                button.addActionListener(new ActionListener(){
                    ...
                    {
                        ballButton.setBorder(ballBorder);
                    }
        ...
        ballBorder = ballButton.getBorder();
        ...
        ballButton.addActionListener(new ActionListener()
        {
            ...
            {
                placingBall = true;
                ballButton.setBorder(BorderFactory.createLineBorder(Color.RED, 2));
                for(EditorButton eb : tileButtons) {
                            ...
                            this.addActionListener(new ActionListener()
                            {
                                ...
                                public void actionPerformed(ActionEvent arg0)
                                {
                                    ...
                                    if( newX >= 10 && newY >= 10) {
                                        ...
                                        JOptionPane.showMessageDialog(null, "The map must be at least 10x10", "Map Size Error", JOptionPane.INFORMATION_MESSAGE);
                                    }
                                }
                            });
                        }
